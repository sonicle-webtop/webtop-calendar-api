 ...
 * @author malbinola
 */
public class ComparableEventRange extends DateTimeRange2 implements Comparable {
	protected final EventInstanceId id;

	public ComparableEventRange(EventInstanceId id, DateTime start, DateTime end) {
